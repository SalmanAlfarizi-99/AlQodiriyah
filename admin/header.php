...
<html>
	<head>
		...
		<script src="https://cdn.tiny.cloud/1/39adzp2k7lputddb4ubz8mpacm7nt05ell9dj3dsfi4jyd73/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
		<script>
	    tinymce.init({
	    selector: '#keterangan'
	    });
	...
	<body class="bg-light">
		...
		<!-- navbar -->
		<div class="navbar" style="background-color:#32CD32;">
			...
			<div class="container">
				...
				<ul class="nav-menu float-left">
					...
					<?php }elseif($_SESSION['ulevel'] == 'Admin'){ ?>
						...
						<li><a href="jurusan.php">Kegiatan</a></li>
